    ...
    <div class="container mx-auto px-5 max-w-6xl">
      ...
      >
        <div class="flex gap-6 items-start">
          <div
            class="w-16 h-16 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center flex-shrink-0"
          >
            <i
              class="fas fa-graduation-cap text-2xl text-black dark:text-white"
            ></i>
          </div>
          <div class="flex-grow">
            ...
            <ul class="space-y-2">
              ...
              >
                <span class="text-black dark:text-white mr-2 mt-1">•</span>
                {{ achievement }}
              </li>
            </ul>
          </div>

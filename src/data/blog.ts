...
export const blogPosts: BlogPostMeta[] = [
  ...
  {
    slug: 'mvc-concept-on-laravel',
    title: 'MVC Concept On Laravel',
    date: '2023-11-15',
    excerpt: 'Understand the fundamental Model-View-Controller (MVC) architectural pattern and how Laravel beautifully implements it to structure your code and improve maintainability.',
  },
  {
